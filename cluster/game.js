...
(function () {
  ...
  var I18N = {
    de: {
      ...
      aria_field: 'Spielfeld. Symbol mit Pfeiltasten oder WASD bewegen, die Pfeiltaste nach unten lässt es schneller fallen, P pausiert.',
      aria_pause: 'Pausieren',
      aria_resume: 'Fortsetzen',
      aria_restart: 'Neu starten',
      help_summary: 'So funktioniert es',
      help_1: 'Mit den Pfeiltasten oder WASD bewegen; die Pfeiltaste nach unten lässt die Form schneller fallen. Wischen und Tippen funktionieren ebenfalls.',
      help_2: 'Drei oder mehr gleiche Formen, die sich berühren, lösen sich auf und geben Punkte.',
    ...
    en: {
      ...
      aria_field: 'Game field. Move the symbol with the arrow keys or WASD, press Down to drop faster, and P to pause.',
      aria_pause: 'Pause',
      aria_resume: 'Resume',
      aria_restart: 'Restart',
      help_summary: 'How it works',
      help_1: 'Move with the arrow keys or WASD. Press Down to drop faster; swiping and tapping work too.',
