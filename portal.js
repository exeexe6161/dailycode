...
(function () {
  ...
  var I18N = {
    de: {
      ...
      tile_drift_name: 'Serpix',
      tile_drift_aria: 'Öffnen: Serpix',
      tile_cluster_name: 'Nexa',
      tile_cluster_aria: 'Öffnen: Nexa',
      tile_echo_name: 'Memora',
      tile_echo_aria: 'Öffnen: Memora',
      tile_glyph_name: 'Lexiq',
      tile_glyph_aria: 'Öffnen: Lexiq',
      tile_grid9_name: 'Numora',
      tile_grid9_aria: 'Öffnen: Numora',
      tile_react7_name: 'Reflexa',
      tile_react7_aria: 'Öffnen: Reflexa',
      tile_flow8_name: 'Fluxa',
      tile_flow8_aria: 'Öffnen: Fluxa',
      tile_picto_name: 'Pixela',
      tile_picto_aria: 'Öffnen: Pixela',
      tile_questra_name: 'Questra',
      tile_questra_aria: 'Öffnen: Questra',
      tile_rankings_name: 'Rangliste',
      tile_rankings_aria: 'Öffnen: Rangliste',
    ...
    en: {
      ...
      tile_drift_name: 'Serpix',
      tile_drift_aria: 'Open: Serpix',
      tile_cluster_name: 'Nexa',
      tile_cluster_aria: 'Open: Nexa',
      tile_echo_name: 'Memora',
      tile_echo_aria: 'Open: Memora',
      tile_glyph_name: 'Lexiq',
      tile_glyph_aria: 'Open: Lexiq',
      tile_grid9_name: 'Numora',
      tile_grid9_aria: 'Open: Numora',
      tile_react7_name: 'Reflexa',
      tile_react7_aria: 'Open: Reflexa',
      tile_flow8_name: 'Fluxa',
      tile_flow8_aria: 'Open: Fluxa',
      tile_picto_name: 'Pixela',
      tile_picto_aria: 'Open: Pixela',
      tile_questra_name: 'Questra',
      tile_questra_aria: 'Open: Questra',
      tile_rankings_name: 'Rankings',
      tile_rankings_aria: 'Open: Rankings',
    ...
    tr: {
      ...
      tile_drift_name: 'Serpix',
      tile_drift_aria: 'Aç: Serpix',
      tile_cluster_name: 'Nexa',
      tile_cluster_aria: 'Aç: Nexa',
      tile_echo_name: 'Memora',
      tile_echo_aria: 'Aç: Memora',
      tile_glyph_name: 'Lexiq',
      tile_glyph_aria: 'Aç: Lexiq',
      tile_grid9_name: 'Numora',
      tile_grid9_aria: 'Aç: Numora',
      tile_react7_name: 'Reflexa',
      tile_react7_aria: 'Aç: Reflexa',
      tile_flow8_name: 'Fluxa',
      tile_flow8_aria: 'Aç: Fluxa',
      tile_picto_name: 'Pixela',
      tile_picto_aria: 'Aç: Pixela',
      tile_questra_name: 'Questra',
      tile_questra_aria: 'Aç: Questra',
      tile_rankings_name: 'Sıralama',
      tile_rankings_aria: 'Aç: Sıralama',
