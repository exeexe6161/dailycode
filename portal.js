...
(function () {
  ...
  var I18N = {
    de: {
      ...
      tile_cluster_name: 'cluster',
      tile_cluster_desc: 'Verbinde drei gleiche Formen und mehr.',
      tile_cluster_aria: 'Öffnen: cluster',
      tile_echo_name: 'echo',
      tile_echo_desc: 'Merke dir die Paare und finde sie wieder.',
      tile_echo_aria: 'Öffnen: echo',
      tile_glyph_name: 'Glyph',
      tile_glyph_desc: 'Bilde Wörter aus den Buchstaben, gegen die Uhr.',
      tile_glyph_aria: 'Öffnen: Glyph',
      tile_grid9_name: 'grid9',
      tile_grid9_desc: 'Fülle das Gitter, jede Zahl einmal pro Zeile, Spalte und Block.',
      tile_grid9_aria: 'Öffnen: grid9',
      tile_react7_name: 'react7',
      tile_react7_desc: 'Wähle blitzschnell die passende Form und Farbe.',
      tile_react7_aria: 'Öffnen: react7',
    ...
    en: {
      ...
      tile_cluster_name: 'cluster',
      tile_cluster_desc: 'Connect three or more matching shapes.',
      tile_cluster_aria: 'Open: cluster',
      tile_echo_name: 'echo',
      tile_echo_desc: 'Memorize the pairs and find them again.',
      tile_echo_aria: 'Open: echo',
      tile_glyph_name: 'Glyph',
      tile_glyph_desc: 'Build words from the letters, against the clock.',
      tile_glyph_aria: 'Open: Glyph',
      tile_grid9_name: 'grid9',
      tile_grid9_desc: 'Fill the grid, each number once per row, column and block.',
      tile_grid9_aria: 'Open: grid9',
      tile_react7_name: 'react7',
      tile_react7_desc: 'Pick the matching shape and colour as fast as you can.',
      tile_react7_aria: 'Open: react7',
    ...
    tr: {
      ...
      tile_cluster_name: 'cluster',
      tile_cluster_desc: 'Üç ve daha fazla aynı şekli birleştir.',
      tile_cluster_aria: 'Aç: cluster',
      tile_echo_name: 'echo',
      tile_echo_desc: 'Çiftleri ezberle ve yeniden bul.',
      tile_echo_aria: 'Aç: echo',
      tile_glyph_name: 'Glyph',
      tile_glyph_desc: 'Harflerden kelimeler kur, zamana karşı.',
      tile_glyph_aria: 'Aç: Glyph',
      tile_grid9_name: 'grid9',
      tile_grid9_desc: 'Gitteri doldur, her sayı satır, sütun ve blokta bir kez.',
      tile_grid9_aria: 'Aç: grid9',
      tile_react7_name: 'react7',
      tile_react7_desc: 'Doğru şekil ve rengi olabildiğince hızlı seç.',
      tile_react7_aria: 'Aç: react7',
