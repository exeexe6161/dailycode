...
(function () {
  ...
  var I18N = {
    de: {
      ...
      help_1: 'Der Code besteht aus mehreren Positionen mit mehreren möglichen Symbolen. Symbole können sich wiederholen.',
      help_2: 'Die Anzahl der Versuche hängt von der gewählten Schwierigkeit ab. Tippe die Symbole und bestätige mit Prüfen.',
      help_diff: 'Über die Schwierigkeit oben wählst du Leicht, Mittel, Schwer oder Experte.',
      help_timer: 'Die Zeit läuft während der Runde. Sie stoppt bei Sieg oder Niederlage.',
    ...
    en: {
      ...
      help_1: 'The code has several positions with several possible symbols. Symbols can repeat.',
      help_2: 'The number of tries depends on the chosen difficulty. Place the symbols and confirm with Check.',
      help_diff: 'The difficulty above lets you choose Easy, Medium, Hard or Expert.',
      help_timer: 'The timer runs during the round. It stops at a win or a loss.',
    ...
    tr: {
      ...
      help_1: 'Kod, birden çok konumdan ve birden çok olası simgeden oluşur. Simgeler tekrarlanabilir.',
      help_2: 'Deneme sayısı seçilen zorluğa bağlıdır. Simgeleri yerleştir ve Kontrol et ile onayla.',
      help_diff: 'Yukarıdaki zorluk seçimiyle Kolay, Orta, Zor veya Uzman seçebilirsin.',
      help_timer: 'Süre tur boyunca işler. Kazandığında veya kaybettiğinde durur.',
  ...
  function applyStaticI18n() {
    ...
    var rankingsLabelEl = document.getElementById('rankingsLabel');
    if (rankingsLabelEl) rankingsLabelEl.textContent = t('rankings');
  }
